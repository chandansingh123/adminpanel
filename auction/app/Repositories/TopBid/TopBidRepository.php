...
namespace App\Repositories\TopBid;
 ...
 */
class TopBidRepository implements TopBidContract
{
    /**
     * Eloquent TopBid Model
     *
     * @var $model
     */
    protected $model;
    ...
    /**
     * Create a new top bid repository instance.
     *
     * @param TopBid $model
     */
    public function __construct(TopBid $model)
    {
        $this->model = $model;
    }
