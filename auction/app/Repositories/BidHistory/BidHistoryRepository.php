...
namespace App\Repositories\BidHistory;

use App\Models\BidHistory\BidHistory;

/**
 * Class BidHistoryRepository
 * @package App\Repositories\BidHistory
 * @author Krishna Prasad Timilsina <bikranshu.t@gmail.com>
 */
class BidHistoryRepository implements BidHistoryContract
{
    /**
     * Eloquent BidHistory Model
     *
     * @var $model
     */
    protected $model;
     ...
     *
     * @param BidHistory $model
     */
    public function __construct(BidHistory $model)
    {
        $this->model = $model;
    }
